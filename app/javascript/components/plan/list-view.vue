  ...
  <div class="row margin-none">
    <div class="col-md-8">
      <div class="col"> Your Tray
        ...
        <div class="drop-down actions">
          ...
          <plan-filter :title="category.name" :items="category.options" :field="category.field" v-for="category in categories" :selectedFilter="selectedFilter" :name="category.name"></plan-filter>
        </div>
        <div class="plan">
          <plan-list-item :lists="filteredCourses" :selectedPlan="selectedPlan">
          </plan-list-item>
        </div>  
      </div>
    </div>  
    <div class="col-md-4">
      <div class="col"> Selected Course
        ...
        <div class="row margin-none">
          <plan-description :course="course"></plan-description>
        </div>  
      </div>
    </div>      
  </div>        
